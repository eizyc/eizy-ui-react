import { FC, useRef, ChangeEvent, useState, PropsWithChildren } from 'react'
import axios from 'axios'
import UploadList from './uploadList'
import { STYLE_PREFIX } from '../../utils/const';
import Dragger from './dragger';

export const prefixCls = `${STYLE_PREFIX}-upload`
  ...
  return (
    ...
    >
      <div className={`${prefixCls}-input`}
        onClick={handleClick}>
          {drag ? 
            <Dragger onFile={(files: FileList) => {uploadFiles(files)}}>
              {children}
            </Dragger>:
            children
          }
